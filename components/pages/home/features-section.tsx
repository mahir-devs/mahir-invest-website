          ...
          {FEATURES_DATA.map((feature) => (
            <MotionItem key={feature.id} direction="up" distance={25} duration={0.5}>
              <GlassCard
                ...
                rounded="2xl"
                padding="none"
                className="bg-white/50 backdrop-blur-xl border border-[var(--blue-normal)]/30 shadow-md shadow-slate-900/5 text-center flex flex-col items-center justify-center p-3.5 sm:p-7 space-y-2 sm:space-y-3 min-h-[150px] sm:min-h-[200px]"
              >
                {/* Icon Container */}
